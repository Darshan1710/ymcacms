...
<!-- Colors -->
          ...
          <hr>
              ...
              <div class="col-md-12 question-row">
                <div class="form-group mb-3 mb-md-2">
                  <label class="font-weight-semibold">2. Cleanliness of Restaurant ?</label>
                  <div class="row checkbox-row">
              ...
              <div class="col-md-12 question-row">
                <div class="form-group mb-3 mb-md-2">
                  <label class="font-weight-semibold">3. Rest Room ?</label>
                  <div class="row checkbox-row">
                      
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_8" class="form-check-input-styled-success" <?php if($feedback['question_8'] == 4){ echo 'checked';}?> data-fouc>
                          Execellent
                        </label>
                      </div>
                      ...
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_8" class="form-check-input-styled-primary" <?php if($feedback['question_8'] == 3){ echo 'checked';}?> data-fouc>
                          Good
                        </label>
                      </div>
                      ...
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_8" class="form-check-input-styled-danger" <?php if($feedback['question_8'] == 2){ echo 'checked';}?> data-fouc>
                          Average
                        </label>
                      </div>
                      ...
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_8" class="form-check-input-styled-danger" <?php if($feedback['question_8'] == 1){ echo 'checked';}?> data-fouc>
                          Poor
                        </label>
                      </div>
              ...
              <div class="col-md-12 question-row">
                <div class="form-group mb-3 mb-md-2">
                  <label class="font-weight-semibold">4. Quality of service ?</label>
                  <div class="row checkbox-row">
                      
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_9" class="form-check-input-styled-success" <?php if($feedback['question_9'] == 4){ echo 'checked';}?> data-fouc>
                          Execellent
                        </label>
                      </div>
                      ...
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_9" class="form-check-input-styled-primary" <?php if($feedback['question_9'] == 3){ echo 'checked';}?> data-fouc>
                          Good
                        </label>
                      </div>
                      ...
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_9" class="form-check-input-styled-danger" <?php if($feedback['question_9'] == 2){ echo 'checked';}?> data-fouc>
                          Average
                        </label>
                      </div>
                      ...
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="radio" name="question_9" class="form-check-input-styled-danger" <?php if($feedback['question_9'] == 1){ echo 'checked';}?> data-fouc>
                          Poor
                        </label>
                      </div>
              ...
              <div class="col-md-12 question-row">
                <div class="form-group mb-3 mb-md-2">
                  <label class="font-weight-semibold">5. Value for Money ?</label>
                  <div class="row checkbox-row">
              ...
              <div class="col-md-12 question-row">
                <div class="form-group mb-3 mb-md-2">
                  <label class="font-weight-semibold">6. Restaurant ambience</label>
                  <div class="row checkbox-row">
