    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <!-- Hover rows -->
                <div class="card">
                    <form method="post" action="<?php echo base_url() ?>Admin/createBulkEmail">
                    ...
                    <button class="btn btn-primary btn-sm ml-1" id="message_to_send" disabled>Email To Send</button>
                    </div>
                    ...
                    <table class="table datatable-basic table-hover text-center" id="birthdayList">
                        ...
                        <tbody>
                            <?php if(isset($customer)){ 
                                ...
                                <tr>
                                    <td><input type="checkbox" name="email[]" value="<?php echo $row['email']; ?>" class="myCheckBox"></td>
                                    <td><?php echo ++$i; ?></td>
